...
(
    ...
    '<h1>Условия использования XaTube</h1>
<p>Последнее обновление: 7 ноября 2025</p>
<h2>1. Принятие условий</h2>
<p>Используя XaTube, вы принимаете эти условия использования и нашу политику конфиденциальности.</p>
<h2>2. Описание сервиса</h2>
<p>XaTube - это платформа для прямого видеостриминга, позволяющая пользователям создавать, транслировать и смотреть видеоконтент в реальном времени.</p>
...
<p>Вы сохраняете все права на контент, который загружаете. Вы даете XaTube лицензию на использование этого контента для оказания сервисов.</p>
<h2>6. Ограничение ответственности</h2>
<p>XaTube предоставляется "как есть" без каких-либо гарантий.</p>
...
(
    ...
    '<h1>Политика конфиденциальности XaTube</h1>
<p>Последнее обновление: 7 ноября 2025</p>
<h2>1. Сбор данных</h2>
...
<h2>4. Cookies</h2>
<p>XaTube использует cookies для сохранения сессии и предпочтений пользователя.</p>
...
(
    ...
    '<h1>Руководство по контенту XaTube</h1>
<p>Последнее обновление: 7 ноября 2025</p>
<h2>1. Разрешенный контент</h2>
<p>XaTube поддерживает широкий спектр контента, включая образовательный, развлекательный, творческий и профессиональный контент.</p>
